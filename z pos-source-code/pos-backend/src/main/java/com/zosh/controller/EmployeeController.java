...
public class EmployeeController {
    ...
    public ResponseEntity<UserDTO> createStoreEmployee(
            @RequestBody UserDTO employee, @org.springframework.lang.NonNull @PathVariable Long storeId) throws Exception {
    ...
    public ResponseEntity<User> createBranchEmployee(@RequestBody User employee, @org.springframework.lang.NonNull @PathVariable Long branchId) throws Exception {
    ...
    public ResponseEntity<User> updateEmployee(@org.springframework.lang.NonNull @PathVariable Long employeeId, @RequestBody User employeeDetails) throws Exception {
    ...
    public ResponseEntity<Void> deleteEmployee(@org.springframework.lang.NonNull @PathVariable Long employeeId) throws Exception {
    ...
    @PreAuthorize("hasAnyRole('ROLE_STORE_ADMIN', 'ROLE_STORE_MANAGER', 'ROLE_BRANCH_ADMIN', 'ROLE_BRANCH_MANAGER')")
    public ResponseEntity<User> findEmployeeById(@org.springframework.lang.NonNull @PathVariable Long employeeId) throws Exception {
    ...
    @PreAuthorize("hasAnyRole('ROLE_STORE_ADMIN', 'ROLE_STORE_MANAGER')")
    public ResponseEntity<List<User>> findStoreEmployees(@org.springframework.lang.NonNull @PathVariable Long storeId) throws Exception {
    ...
    public ResponseEntity<List<User>> findBranchEmployees(
            @org.springframework.lang.NonNull @PathVariable Long branchId,
