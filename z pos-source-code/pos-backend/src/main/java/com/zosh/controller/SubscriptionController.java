...
public class SubscriptionController {
    ...
    public ResponseEntity<?> createSubscription(
            @org.springframework.lang.NonNull @RequestParam Long storeId,
            @org.springframework.lang.NonNull @RequestParam Long planId,
    ...
    public Subscription activateSubscription(@org.springframework.lang.NonNull @PathVariable Long subscriptionId) {
        return subscriptionService.activateSubscription(subscriptionId);
    }

    // ❌ Admin cancels a subscription
    @PutMapping("/{subscriptionId}/cancel")
    public Subscription cancelSubscription(@org.springframework.lang.NonNull @PathVariable Long subscriptionId) {
    ...
    public Subscription updatePaymentStatus(
            @org.springframework.lang.NonNull @PathVariable Long subscriptionId,
    ...
    public List<Subscription> getStoreSubscriptions(
            @org.springframework.lang.NonNull @PathVariable Long storeId,
