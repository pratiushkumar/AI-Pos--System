...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    @Transactional
    public UserDTO createStoreEmployee(UserDTO dto, @org.springframework.lang.NonNull Long storeId) throws Exception {
    ...
    @Override
    public User createBranchEmployee(User employee, @org.springframework.lang.NonNull Long branchId) throws Exception {
    ...
    @Override
    public User updateEmployee(@org.springframework.lang.NonNull Long employeeId, User employeeDetails) throws Exception {
        ...
        if (existingEmployee == null) throw new IllegalStateException("Existing employee cannot be null");
        return userRepository.save(existingEmployee);
    }

    @Override
    public void deleteEmployee(@org.springframework.lang.NonNull Long employeeId) throws Exception {
        User employee = findEmployeeById(employeeId);
        if (employee == null) throw new IllegalStateException("Employee cannot be null");
        userRepository.delete(employee);
    }

    @Override
    public User findEmployeeById(@org.springframework.lang.NonNull Long employeeId) throws Exception {
    ...
    @Override
    public List<User> findStoreEmployees(@org.springframework.lang.NonNull Long storeId, UserRole role) throws Exception {
        Store store = storeRepository.findById(storeId)
                .orElseThrow(() -> new ResourceNotFoundException("Store not found with ID: " + storeId));
    ...
    @Override
    public List<User> findBranchEmployees(@org.springframework.lang.NonNull Long branchId, UserRole role) throws Exception {
        Branch branch = branchRepository.findById(branchId)
                .orElseThrow(() -> new ResourceNotFoundException("Branch not found with ID: " + branchId));
