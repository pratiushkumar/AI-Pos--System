...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    @Override
    @Transactional
    public PaymentInitiateResponse createSubscription(@org.springframework.lang.NonNull Long storeId,
        ...
        if (savedSub == null) throw new IllegalStateException("Failed to save subscription");
    ...
    @Override
    public PaymentInitiateResponse upgradeSubscription(@org.springframework.lang.NonNull Long storeId,
                                            @org.springframework.lang.NonNull Long planId, PaymentGateway gateway,
                                            String transactionId) throws PaymentException {
        Store store = storeRepository.findById(storeId)
                .orElseThrow(() -> new EntityNotFoundException("Store not found"));
        ...
        if (updatedSubscription == null) throw new IllegalStateException("Failed to update subscription");
    ...
    @Override
    public Subscription activateSubscription(@org.springframework.lang.NonNull Long subscriptionId) {
    ...
    @Override
    public Subscription cancelSubscription(@org.springframework.lang.NonNull Long subscriptionId) {
        Subscription sub = subscriptionRepository.findById(subscriptionId)
                .orElseThrow(() -> new RuntimeException("Subscription not found"));
        sub.setStatus(SubscriptionStatus.CANCELLED);
        return subscriptionRepository.save(sub);
    ...
    @Override
    public Subscription updatePaymentStatus(@org.springframework.lang.NonNull Long subscriptionId, PaymentStatus status) {
        Subscription sub = subscriptionRepository.findById(subscriptionId)
                .orElseThrow(() -> new RuntimeException("Subscription not found"));
