            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <Button
                  ...
                  onClick={() => window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/oauth2/authorization/google`}
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-12 flex items-center justify-center gap-2 hover:bg-background/90 font-medium border-foreground/20 bg-background/50 shadow-sm backdrop-blur-sm"
                  onClick={() => window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/oauth2/authorization/github`}
                >
