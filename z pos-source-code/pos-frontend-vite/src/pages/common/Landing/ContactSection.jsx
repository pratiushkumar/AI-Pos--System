              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">+91 9142964035</p>
                    <p className="opacity-90">+91 9142964035</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">pratiusht81300@gmail.com</p>
                    <p className="opacity-90">pratiusht81300@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">Dholakpur mayanagri </p>
                    <p className="opacity-90">raja ka mahal</p>
                  </div>
                </div>
