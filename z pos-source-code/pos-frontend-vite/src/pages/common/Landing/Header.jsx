...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-background/80 backdrop-blur-md shadow-md border-b' : 'bg-transparent'}`}>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-2 group cursor-pointer" onClick={() => navigate('/')}>
                ...
                <span className="text-xl font-bold text-foreground group-hover:text-primary transition-colors">Patty POS</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <ThemeToggle />
              <Button onClick={handleLoginButtonClick} variant="outline" className="text-black border-black hover:bg-black/5 font-medium">Sign In</Button>
              <Button className="bg-black text-white hover:bg-black/80 font-medium shadow-md hover:shadow-lg transition-shadow">Request Demo</Button>
            </div>
            ...
            <div className="md:hidden py-4 border-t border-border bg-background">
              <nav className="flex flex-col">
                ...
                <div className="flex flex-col space-y-3 p-4">
                  <Button onClick={handleLoginButtonClick} variant="outline" className="w-full text-black border-black hover:bg-black/5">Sign In</Button>
                  <Button className="w-full bg-black text-white hover:bg-black/80">Request Demo</Button>
                </div>
              </nav>
            </div>
          )}
