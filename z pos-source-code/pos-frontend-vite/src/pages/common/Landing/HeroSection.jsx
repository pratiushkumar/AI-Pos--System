...
const HeroSection = () => {
  ...
  return (
    <section className="pt-24 pb-16 bg-background relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-[600px] bg-primary/5 -skew-y-6 transform origin-top-left -z-10 shadow-inner"></div>
      <div className="absolute top-20 right-[-100px] w-96 h-96 bg-primary/10 rounded-full blur-3xl -z-10 animate-pulse"></div>
      <div className="absolute bottom-10 left-[-100px] w-96 h-96 bg-secondary/10 rounded-full blur-3xl -z-10"></div>
      {/* Background Pattern */}
          ...
          >
            {[
              ...
              <a 
                href="#features"
                key={index} 
                className="cursor-pointer flex items-center space-x-1 bg-card/80 backdrop-blur-sm rounded-full px-3 py-1 text-sm shadow-sm border animate-fade-in-up hover:scale-105 transition-all duration-300"
