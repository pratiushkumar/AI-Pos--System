  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-indigo-50">
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#8D6E63] via-[#5D4037] to-[#3E2723] relative overflow-hidden">
          {/* Background Pattern */}
          ...
          {/* Content */}
          <div className="relative z-10 flex flex-col justify-center items-center text-[#F5F5DC] px-12">
            <div className="text-center max-w-md">
              {/* Icon */}
              <div className="mb-8">
                <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm">
                  <svg className="w-10 h-10 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
              </div>
              ...
              <h1 className="text-4xl font-bold mb-6 leading-tight">
                Welcome to Your
                <span className="block text-[#F5F5DC]">POS System</span>
              </h1>
              
              {/* Description */}
              <p className="text-lg text-[#F5F5DC] mb-8 leading-relaxed">
                Get your business up and running in minutes with a smart, streamlined setup.
                 Configure your store profile, organize products, and unlock powerful tools to 
                 manage sales, inventory, and customers—all 
                from one place. Start building a faster, smarter retail experience today.
              </p>
              
              {/* Features List */}
              <div className="space-y-4 text-left">
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-[#A1887F] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    <svg className="w-4 h-4 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-[#F5F5DC]">Easy AI based inventory management</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-[#A1887F] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    <svg className="w-4 h-4 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-[#F5F5DC]">Real-time sales Analytics and tracking</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-[#A1887F] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    <svg className="w-4 h-4 text-[#F5F5DC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-[#F5F5DC]">Secure payment processing</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center p-8 lg:p-8 pt-32 lg:pt-8 lg:h-screen lg:overflow-y-auto relative">
          {/* Home Button */}
          <button
            onClick={() => navigate('/')}
            className="absolute top-8 right-8 flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-full shadow-sm hover:bg-gray-50 hover:text-gray-900 transition-all focus:outline-none focus:ring-2 focus:ring-primary/20 z-10"
          >
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-[#8D6E63] to-[#3E2723] h-2 rounded-full transition-all duration-500 ease-out"
